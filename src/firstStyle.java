/**
 * Mancala : FirstStyle
 * First Concrete class for interface Style for the Strategy Pattern 
...
/**
 * First concrete strategy that implements Style interface
 */
public class FirstStyle implements Style{
    /**
    ...
    /**
     * Method that paints ellipse as pits
     * @param g is the graphics that is responsible for painting the pits
